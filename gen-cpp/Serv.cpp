...
void ServClient::get(Student& _return, const int32_t sno)
{
  send_get(sno);
  recv_get(_return);
}

void ServClient::send_get(const int32_t sno)
{
  int32_t cseqid = 0;
...
void ServClient::recv_get(Student& _return)
{
...
void ServConcurrentClient::get(Student& _return, const int32_t sno)
{
  int32_t seqid = send_get(sno);
  recv_get(_return, seqid);
}

int32_t ServConcurrentClient::send_get(const int32_t sno)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("get", ::apache::thrift::protocol::T_CALL, cseqid);
...
void ServConcurrentClient::recv_get(Student& _return, const int32_t seqid)
{
